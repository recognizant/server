 ...
 * @author sumit
 */
public class add_user_photo extends HttpServlet {
        ...
        try {
          ...
          Enumeration params = mr.getParameterNames();
			while (params.hasMoreElements()) 
			{
				...
				{
					uname=mr.getParameter(paramname);
				}
			...
			Enumeration files = mr.getFileNames();	
                        while (files.hasMoreElements()) 
                        {
                            ...
                            if(paramname != null && paramname.equals("image"))
                            {
                                ...
                                String newPath=npath+uname+"_"+n+".jpg";
            ...
            mn.initfd(mat,path_info.pathwhr+"/haarcascades/haarcascade_frontalface_alt.xml",path,uname+"_"+n+".jpg",uname);
            ...
            ex.printStackTrace();
                    ...
                    rd=request.getRequestDispatcher("upload_photo.jsp?name="+uname);
